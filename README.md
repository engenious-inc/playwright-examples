...
🔮 Press Enter! 👀 To witness the versions of Node.js and npm materialize before your eyes.
...
When git is installed 🌟: Open GitBash or Vscode in the folder where you wish to welcome the repository. 📂 And type the command below and press enter 🚀:
