...
test.describe('Car Booking Negative Tests', () => {
  test('should not allow booking without selecting dates', async ({ bookingCarPage }) => {
  ...
  test('should not allow booking for an unavailable car model', async ({ bookingCarPage }) => {
    await bookingCarPage.openBookingPage();
  ...
  test('should not allow booking with invalid payment details', async ({ bookingCarPage }) => {
    await bookingCarPage.openBookingPage();
