...
test.describe('About Us Page', () => {
  ...
  test('Verify "Our Mission" section is visible and contains correct text', async ({
    aboutUsPage,
  }) => {
  ...
  test('Verify "Our Fleet" section is visible and contains correct text', async ({
    aboutUsPage,
  }) => {
  ...
  test('Verify "Unmatched Quality" section is visible and contains correct text', async ({
    aboutUsPage,
  }) => {
  ...
  test('Verify "Premier Service" section is visible and contains correct text', async ({
    aboutUsPage,
  }) => {
  ...
  test('Verify "Join the Elite" section is visible and contains correct text', async ({
    aboutUsPage,
  }) => {
  ...
  test('Verify "Contact Us" section contains phone and email links', async ({
    aboutUsPage,
  }) => {
